...
func _on_extras_button_up() -> void:
	uiRelease()

func _on_extras_button_down() -> void:
	uiPress()
...
func _on_changelog_button_down() -> void:
	uiPress()


func _on_changelog_button_up() -> void:
	uiRelease()


func _on_changelog_mouse_entered() -> void:
	uiHover()


func _on_changelog_pressed() -> void:
	get_tree().change_scene_to_file("res://changelog.tscn")
